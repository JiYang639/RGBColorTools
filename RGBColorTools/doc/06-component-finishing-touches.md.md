...
- **Due Date**: <!-- TODO: fill out with due date and time (e.g., 10/17 @ 3:10 PM EST) and delete this comment -->4/19 @11:59 PM EST
...
<!-- TODO: discuss -->
Before starting the portfolio project, I can say that I had little to no understanding of software development. However, after the partner project and portfolio project this semester, I have some new understanding of software development. Building the project I wanted to realize from 0 was both exciting and worrying for me at first. It involves pre-brainstorming, conceptual implementation, and mid- and late-stage constant optimization of previous code, trying to find a minimalist, practical implementation. Planning, designing, and coding, each of these phases, are very important in software development. Of course, after doing this, my understanding of software development went even further.
...
<!-- TODO: discuss -->
Of course it does. Starting with a blank document meant that I had to do it all myself. I modeled the template given in the project and went to the OSU API site to try to find code that matched my theme. However, it wasn't as easy as I thought it would be. Often times I would get warnings or bugs due to my lack of solid skills. For example, even though I know exactly what my methods are, I don't really know how to create a secondary class, or sometimes I don't know in which class my methods should be placed. Fortunately, though, I can clearly feel that each time I start writing a portfolio project, I am more confident and think more clearly than the previous time.
...
<!-- TODO: discuss -->
In my mind, software development has always been a very daunting, difficult and hard process. It was so far away that I thought I was nowhere near being able to develop software at my current level. However, when I actually started designing portfolio projects, breaking them down into each step, each part, and perfecting them separately, I realized that it was not as abstract, difficult, and unattainable as I thought. When I actually made what I thought was a practical approach, a program, it was a sense of accomplishment for me that I had never felt before. I enjoy software development because I enjoy being able to get ideas off the ground.
...
In addition to software skills, I think I actually learned more skills for computer learning and my skills for completing projects independently. Stepping out of the textbook, I need to have the ability to design mine by looking at the various components of the OSU API, which requires flexibility to adapt at this time. I learned to design my own convention/correspondence by using the Natural Number Component, and a good design is always a work in progress. Each refinement not only strengthens my software skills, but also hones my level of rigor. Although two methods may look like they have the same functionality on the client side, their code length, complexity, and input/output variables are all important. Therefore, this is a problem I need to solve on my own. Of course, I learned much more than that, and it was a great opportunity.
...
**Project Experience: RGB Tool Component Development**
-   **Position:** Software Developer
-   **Location:** Columbus
-   **Duration:** January 2024 - April 2024

**Responsibilities:**
-   Designed and implemented an RGB Tool component based on the OSU integer component, including methods for extracting colors, blending colors, and converting to grayscale.
-   Independently solved complex coding challenges with a focus on optimizing code structure, reducing complexity, and improving input/output processing.
**Achievements:**
-   Developed rigorous thinking and problem-solving skills by independently resolving software design issues.
-   Gained expertise in abstract and kernel class structures, enhancing understanding of software architecture.
-   Applied theoretical knowledge in practical, real-world development scenarios.
...
<!-- TODO: discuss -->
Now I'm more interested in my chosen subject. After coming up with this theme, I also searched a lot of related topics and web pages trying to find an established color matching site. However, there really wasn't a site that was particularly able to meet my requirements. Therefore, the project I am working on is very meaningful, at least to me.
...
I would like to pursue a career related to computer vision (image processing) afterward. For this reason, I chose to minor in physics to learn more about optics. Also, as a data analytics major, I was able to learn a lot about math, statistics, and computers in my minor. Therefore, more hands-on projects and background knowledge in the direction of computer vision is what I need for me now. Therefore, I am going to read books and literature related to computer vision. At the same time, choosing machine learning, computer vision related courses in data analytics specialization electives after that will also be more helpful for my career path. For mentors, I would like to find out if there are mentors in this area after I learn more related knowledge.
